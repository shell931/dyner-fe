...
export class NavService implements OnDestroy {
  ...
  MENUITEMS: Menu[] = [
    ...
    // },
    {
      // path: '/dashboard', title: 'Dashboard', type: 'link', icon: 'dashboard', badgeClass: 'success', badgeValue: '1', active: true,
    ...
    // {
    //   path: '/account-state', title: 'Estado de cuenta', type: 'link', icon: 'dashboard', badgeClass: 'success', active: true,
    // },
    {
      // path: '/dashboard', title: 'Dashboard', type: 'link', icon: 'dashboard', badgeClass: 'success', badgeValue: '1', active: true,
