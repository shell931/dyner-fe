...
export class DashboardComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.AccountStateService.GetTotalSumTransactions().subscribe(
            (Alldata) => {
                ...
                this.transactionService.GetTransactionList().subscribe((TransactionListdata) => { this.GetTransactionListF(TransactionListdata) });
            },
            error => {
    ...
    GetTotalSumTransactionsF(Alldata) {
        ...
        this.en_transfe_total_sum_service = Alldata.data.en_transfe_total_sum_service;
